...
# Form implementation generated from reading ui file 'excavatorprogram.ui'
#
...
class Ui_ExcavatorProgram(object):
    def setupUi(self, ExcavatorProgram):
        ...
        self.send_data.clicked.connect(self.show_values)
    ...
    def show_values(self):
        ...
        print("X:", self.input_x.text())
        print("Y:", self.input_y.text())
        print("Z:", self.input_z.text())
        print("Pitch:", self.input_pitch.text())
        print("Roll:", self.input_roll.text())
        print("Yaw:", self.input_yaw.text())
