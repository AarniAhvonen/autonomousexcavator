...
DATA_AI1_LIST = []
DATA_AI2_LIST = []
# PID_CONFIG = {'Joint_1': {'p': 18, 'i': 0.0005, 'd': 15},
#               'Joint_2': {'p': 35, 'i': 0.001, 'd': 15},
#               'Joint_3': {'p': 45, 'i': 0.001, 'd': 20}}
...
def main(target_l=[0.1, 0.1, 0.1], i=0):
    ...
    # if abs(deviation_motor[0]) <= 0.01 and abs(deviation_motor[1]) <= 0.006 and abs(deviation_motor[2]) <= 0.025:
    #     print('success')
    #     return [50, 30, 25]
